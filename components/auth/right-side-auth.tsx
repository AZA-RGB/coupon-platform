      ...
      <Tabs defaultValue={defaultTab} className="w-full flex justify-center">
        <div className="w-full flex justify-center">
          <TabsList className="grid w-90 grid-cols-2 rounded-[40px] p-[6px] h-10 mb-6 bg-primary/20">
            <TabsTrigger
              value="login"
              className="rounded-[40px] h-7 data-[state=active]:bg-primary data-[state=active]:text-white bg-transparent transition-colors duration-200 cursor-pointer"
            >
              Login
            </TabsTrigger>
            <TabsTrigger
